...
This repository contains a three-chart dashboard generated from `scorecard.csv` for the frontier coding model benchmark-gaming-risk report.

Open `index.html` through GitHub Pages to view:

- Risk vs raw coding generalization scatter
